...
const Cases = () => {
  ...
  return (
    <section id="cases" className="py-20 bg-gray-50 relative overflow-hidden">
      {/* Background Dots */}
      <div className="absolute top-16 left-16 w-2 h-2 bg-cyan-300 rounded-full animate-float opacity-40"></div>
      <div className="absolute bottom-20 right-20 w-3 h-3 bg-blue-300 rounded-full animate-float-delayed opacity-30"></div>
      <div className="absolute top-1/3 right-1/3 w-2 h-2 bg-purple-300 rounded-full animate-float-slow opacity-50"></div>
          ...
          {cases.map((case_, index) => (
            ...
            >
              ...
              <div className="space-y-6">
                ...
                <div>
                  <h4 className="font-semibold text-cyan-600 mb-2">Rozwiązanie:</h4>
                  <p className="text-gray-600 text-sm">{case_.solution}</p>
                </div>

                <div>
                  <h4 className="font-semibold text-green-600 mb-2">Efekt:</h4>
                  <p className="text-gray-600 text-sm mb-4">{case_.result}</p>
