            ...
            >
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <p className="font-body text-gray-600 text-sm">{case_.problem}</p>
                </div>

                <div>
                  <h4 className="font-heading font-semibold text-cyan-600 mb-2">Rozwiązanie:</h4>
                  <p className="font-body text-gray-600 text-sm">{case_.solution}</p>
                </div>

                <div>
                  <h4 className="font-heading font-semibold text-green-600 mb-2">Efekt:</h4>
                  <p className="font-body text-gray-600 text-sm mb-4">{case_.result}</p>
