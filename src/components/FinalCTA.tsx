...
const FinalCTA = () => {
  return (
    <section className="py-20 bg-white dark:bg-gray-900 relative overflow-hidden">
      {/* Background Elements */}
      <div className="absolute inset-0 bg-gradient-to-br from-cyan-50 to-blue-50 dark:from-gray-800 dark:to-gray-700"></div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div className="text-center px-2 sm:px-0">
          <div className="mb-8">
            <Calendar size={64} className="text-cyan-600 dark:text-cyan-400 mx-auto mb-6 animate-pulse" />
            <h2 className="text-3xl lg:text-4xl font-heading font-bold text-gray-800 dark:text-white mb-6 leading-tight">
              Masz 15 minut i pomysł na usprawnienie swojej pracy?
            </h2>
            <div className="w-24 h-1 bg-cyan-500 rounded-full mx-auto mb-8"></div>
          </div>

          <p className="text-lg font-body text-gray-600 dark:text-gray-300 mb-12 max-w-4xl mx-auto leading-relaxed">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
            <button
              ...
              className="group bg-cyan-500 hover:bg-cyan-600 text-white px-8 py-4 rounded-lg font-body font-semibold shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-200 flex items-center justify-center space-x-3 w-full sm:w-auto"
            >
            ...
            <div className="text-center">
              <p className="text-sm font-body text-gray-500 dark:text-gray-400">lub</p>
            </div>

            <a
              href="tel:+48571570330"
              className="font-body text-gray-700 dark:text-gray-300 hover:text-cyan-600 dark:hover:text-cyan-400 transition-colors duration-200 flex items-center space-x-2"
            >
              <Phone size={20} className="text-cyan-500 dark:text-cyan-400" />
              <span className="font-semibold">+48 571 570 330</span>
            </a>
          </div>

          <div className="mt-12 text-center">
            <p className="font-body text-gray-500 dark:text-gray-400 text-sm max-w-2xl mx-auto">
