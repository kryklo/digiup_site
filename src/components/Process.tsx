...
const Process = () => {
  ...
  return (
    <section id="process" className="py-20 bg-gray-50 dark:bg-gray-800 relative overflow-hidden">
      {/* Background Dots */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-3 gap-8 lg:gap-12 px-2 sm:px-0 justify-items-center">
          {steps.map((step, index) => (
            <div key={index} className="relative group w-full max-w-sm lg:max-w-none">
              ...
              <div className="relative bg-white dark:bg-gray-700 p-6 sm:p-8 rounded-2xl shadow-lg hover:shadow-2xl dark:hover:shadow-2xl transform sm:hover:scale-105 transition-all duration-300 border border-gray-100 dark:border-gray-600 ml-6 sm:ml-0">
                {/* Step Number */}
                <div className="absolute -top-4 -left-3 sm:-left-4 w-12 h-12 bg-cyan-500 dark:bg-cyan-600 text-white rounded-full flex items-center justify-center font-bold text-lg shadow-lg">
                  {step.number}
                </div>
                ...
                <div className="text-center">
                  ...
                  {/* Content */}
                  <h3 className="text-xl font-heading font-bold text-gray-800 dark:text-white mb-4 group-hover:text-cyan-600 dark:group-hover:text-cyan-400 transition-colors duration-300">
                    {step.title}
                  </h3>
                ...
                {/* Hover Effect */}
                <div className="absolute inset-0 bg-cyan-500/0 group-hover:bg-cyan-500/5 dark:group-hover:bg-cyan-500/10 rounded-2xl transition-all duration-300 pointer-events-none"></div>
              </div>
            </div>
          ))}
        </div>
        ...
        <div className="mt-16 text-center">
          <div className="bg-white dark:bg-gray-700 p-6 sm:p-8 rounded-2xl shadow-lg border border-gray-100 dark:border-gray-600 max-w-4xl mx-auto mx-4 sm:mx-auto">
